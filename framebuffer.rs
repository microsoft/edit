...
pub const DEFAULT_THEME: [u32; INDEXED_COLORS_COUNT] = [
    ...
    0xfff8f8f8, // 01
    0xffd00000, // 02
    0xffff6600, // 03 orange makes the clicked menu blue
    0xffcc8800, // 04
    0xff000000, // 05
    0xffa000a0, // 06
    0xff008080, // 07
    0xff000000, // 08 black menu text color
    0xff000000, // 09
    0xffff3333, // 10
    0xff00cc00, // 11
    0xffffaa00, // 12
    0xff000000, // 13 black makes grey bars with black text
    0xffff66ff, // 14
    0xff00ffff, // 15
    0xff202020, // 16
    0xffffffff, // 17 White (default foreground)
    0xff000000, // 18 Black (default background)
    ...
    0xfff0e100, // 15
    0xffffffff, // 16
    0xff000000, // 17 Black (default background)
    0xffffffff, // 18 White (default foreground)
    */
];
