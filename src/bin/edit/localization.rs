...
pub enum LocId {
    ...
    ShortcutMoveCursorLeftWord,
    ShortcutMoveCursorRightWord,
    ShortcutMoveToDocStart,
    ShortcutMoveToDocEnd,
    ShortcutSelectLeftWord,
    ShortcutSelectRightWord,
    ShortcutSelectLineStart,
    ShortcutSelectLineEnd,
    ShortcutSelectDocStart,
    ShortcutSelectDocEnd,
    ShortcutSelectLine,
    ShortcutDeletePrevWord,
    ShortcutDeleteNextWord,
    ShortcutPasteShiftInsert,
    ShortcutCopyCtrlInsert,
    ShortcutCutShiftDelete,
    ShortcutMoveCursorLeftWordMac,
    ShortcutMoveCursorRightWordMac,
...
const S_LANG_LUT: [[&str; LangId::Count as usize]; LocId::Count as usize] = [
    ...
    [
        ...
        // ShortcutMoveCursorLeftWord
    [
        /* en      */ "Move cursor left by word",
        /* de      */ "Cursor wortweise nach links",
        /* es      */ "Mover cursor una palabra a la izquierda",
        /* fr      */ "Déplacer le curseur d’un mot à gauche",
        /* it      */ "Sposta cursore di una parola a sinistra",
        /* ja      */ "単語単位で左へ移動",
        /* ko      */ "단어 단위로 왼쪽 이동",
        /* pt_br   */ "Mover cursor uma palavra à esquerda",
    ...
    // ShortcutMoveCursorRightWord
    [
        /* en      */ "Move cursor right by word",
        /* de      */ "Cursor wortweise nach rechts",
        /* es      */ "Mover cursor una palabra a la derecha",
        /* fr      */ "Déplacer le curseur d’un mot à droite",
        /* it      */ "Sposta cursore di una parola a destra",
        /* ja      */ "単語単位で右へ移動",
        /* ko      */ "단어 단위로 오른쪽 이동",
        /* pt_br   */ "Mover cursor uma palavra à direita",
    ...
    // ShortcutMoveToDocStart
    [
        /* en      */ "Move to start of document",
        /* de      */ "Zum Dokumentanfang",
        /* es      */ "Ir al inicio del documento",
        /* fr      */ "Aller au début du document",
        /* it      */ "Vai all’inizio del documento",
        /* ja      */ "ドキュメントの先頭へ移動",
        /* ko      */ "문서 처음으로 이동",
        /* pt_br   */ "Ir para o início do documento",
        /* ru      */ "В начало документа",
        /* zh_hans */ "移到文档开头",
        /* zh_hant */ "移至文件開頭",
    ],
    // ShortcutMoveToDocEnd
    [
        /* en      */ "Move to end of document",
        /* de      */ "Zum Dokumentende",
        /* es      */ "Ir al final del documento",
        /* fr      */ "Aller à la fin du document",
        /* it      */ "Vai alla fine del documento",
        /* ja      */ "ドキュメントの末尾へ移動",
        /* ko      */ "문서 끝으로 이동",
        /* pt_br   */ "Ir para o final do documento",
    ...
    // ShortcutSelectLeftWord
    [
        /* en      */ "Select left by word",
        /* de      */ "Wortweise nach links auswählen",
        /* es      */ "Seleccionar una palabra a la izquierda",
        /* fr      */ "Sélectionner d’un mot à gauche",
        /* it      */ "Seleziona una parola a sinistra",
        /* ja      */ "単語単位で左を選択",
        /* ko      */ "단어 단위로 왼쪽 선택",
        /* pt_br   */ "Selecionar uma palavra à esquerda",
        /* ru      */ "Выделить слово влево",
        /* zh_hans */ "按词选择左侧",
        /* zh_hant */ "按詞選取左側",
    ],
    // ShortcutSelectRightWord
    [
        /* en      */ "Select right by word",
        /* de      */ "Wortweise nach rechts auswählen",
        /* es      */ "Seleccionar una palabra a la derecha",
        /* fr      */ "Sélectionner d’un mot à droite",
        /* it      */ "Seleziona una parola a destra",
        /* ja      */ "単語単位で右を選択",
        /* ko      */ "단어 단위로 오른쪽 선택",
        /* pt_br   */ "Selecionar uma palavra à direita",
        /* ru      */ "Выделить слово вправо",
        /* zh_hans */ "按词选择右侧",
        /* zh_hant */ "按詞選取右側",
    ],
    // ShortcutSelectLineStart
    [
        /* en      */ "Select to start of line",
        /* de      */ "Bis zum Zeilenanfang auswählen",
        /* es      */ "Seleccionar hasta el inicio de la línea",
        /* fr      */ "Sélectionner jusqu’au début de la ligne",
        /* it      */ "Seleziona fino all’inizio della riga",
        /* ja      */ "行頭まで選択",
        /* ko      */ "줄 시작까지 선택",
        /* pt_br   */ "Selecionar até o início da linha",
        /* ru      */ "Выделить до начала строки",
        /* zh_hans */ "选择到行首",
        /* zh_hant */ "選取到行首",
    ],
    // ShortcutSelectLineEnd
    [
        /* en      */ "Select to end of line",
        /* de      */ "Bis zum Zeilenende auswählen",
        /* es      */ "Seleccionar hasta el final de la línea",
        /* fr      */ "Sélectionner jusqu’à la fin de la ligne",
        /* it      */ "Seleziona fino alla fine della riga",
        /* ja      */ "行末まで選択",
        /* ko      */ "줄 끝까지 선택",
        /* pt_br   */ "Selecionar até o final da linha",
        /* ru      */ "Выделить до конца строки",
        /* zh_hans */ "选择到行尾",
        /* zh_hant */ "選取到行尾",
    ],
    // ShortcutSelectDocStart
    [
        /* en      */ "Select to start of document",
        /* de      */ "Bis zum Dokumentanfang auswählen",
        /* es      */ "Seleccionar hasta el inicio del documento",
        /* fr      */ "Sélectionner jusqu’au début du document",
        /* it      */ "Seleziona fino all’inizio del documento",
        /* ja      */ "ドキュメントの先頭まで選択",
        /* ko      */ "문서 처음까지 선택",
        /* pt_br   */ "Selecionar até o início do documento",
        /* ru      */ "Выделить до начала документа",
        /* zh_hans */ "选择到文档开头",
        /* zh_hant */ "選取到文件開頭",
    ],
    // ShortcutSelectDocEnd
    [
        /* en      */ "Select to end of document",
        /* de      */ "Bis zum Dokumentende auswählen",
        /* es      */ "Seleccionar hasta el final del documento",
        /* fr      */ "Sélectionner jusqu’à la fin du document",
        /* it      */ "Seleziona fino alla fine del documento",
        /* ja      */ "ドキュメントの末尾まで選択",
        /* ko      */ "문서 끝까지 선택",
        /* pt_br   */ "Selecionar até o final do documento",
        /* ru      */ "Выделить до конца документа",
        /* zh_hans */ "选择到文档结尾",
        /* zh_hant */ "選取到文件結尾",
    ],
    // ShortcutSelectLine
    ...
    [
        ...
        /* de      */ "Vorheriges Wort löschen",
        /* es      */ "Eliminar palabra anterior",
        /* fr      */ "Supprimer le mot précédent",
        /* it      */ "Elimina la parola precedente",
        /* ja      */ "前の単語を削除",
        /* ko      */ "이전 단어 삭제",
        /* pt_br   */ "Excluir palavra anterior",
        /* ru      */ "Удалить предыдущее слово",
        /* zh_hans */ "删除前一个词",
        /* zh_hant */ "刪除前一詞",
    ],
    // ShortcutDeleteNextWord
    [
        /* en      */ "Delete next word",
        /* de      */ "Nächstes Wort löschen",
        /* es      */ "Eliminar palabra siguiente",
        /* fr      */ "Supprimer le мот suivant",
        /* it      */ "Elimina la parola successiva",
        /* ja      */ "次の単語を削除",
        /* ko      */ "다음 단어 삭제",
        /* pt_br   */ "Excluir próxima palavra",
        /* ru      */ "Удалить следующее слово",
        /* zh_hans */ "删除下一个词",
        /* zh_hant */ "刪除下一詞",
    ],
    // ShortcutPasteShiftInsert
    ...
    // ShortcutMoveCursorLeftWordMac
    [
        /* en      */ "Move cursor left by word (macOS)",
        /* de      */ "Cursor wortweise nach links (macOS)",
        /* es      */ "Mover cursor una palabra a la izquierda (macOS)",
        /* fr      */ "Déplacer le curseur d’un mot à gauche (macOS)",
        /* it      */ "Sposta cursore di una parola a sinistra (macOS)",
        /* ja      */ "単語単位で左へ移動 (macOS)",
        /* ko      */ "단어 단위로 왼쪽 이동 (macOS)",
        /* pt_br   */ "Mover cursor uma palavra à esquerda (macOS)",
        /* ru      */ "Переместить курсор на слово влево (macOS)",
        /* zh_hans */ "光标左移一词 (macOS)",
        /* zh_hant */ "游標左移一詞 (macOS)",
    ],
    // ShortcutMoveCursorRightWordMac
    [
        /* en      */ "Move cursor right by word (macOS)",
        /* de      */ "Cursor wortweise nach rechts (macOS)",
        /* es      */ "Mover cursor una palabra a la derecha (macOS)",
        /* fr      */ "Déplacer le curseur d’un mot à droite (macOS)",
        /* it      */ "Sposta cursore di una parola a destra (macOS)",
        /* ja      */ "単語単位で右へ移動 (macOS)",
        /* ko      */ "단어 단위로 오른쪽 이동 (macOS)",
        /* pt_br   */ "Mover cursor uma palavra à direita (macOS)",
        /* ru      */ "Переместить курсор на слово вправо (macOS)",
        /* zh_hans */ "光标右移一词 (macOS)",
        /* zh_hant */ "游標右移一詞 (macOS)",
    ],
];
